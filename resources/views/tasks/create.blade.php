...
@section('content')
    ...
    <div class="min-h-screen flex items-center justify-center p-6">
        <form action="{{ route('tasks.store') }}" method="POST" class="max-w-lg w-full bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <!-- Дедлайн -->
            <div class="mb-4">
                <label for="deadline_display" class="block text-gray-900 dark:text-white text-lg font-medium mb-2">Дедлайн</label>
                <input type="text" id="deadline_display" class="flatpickr w-full p-3 bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600 rounded-md" placeholder="Выберите дату и время" required>
            ...
            <div class="flex items-center justify-end space-x-3">
                <a href="{{ route('tasks.index') }}" class="px-4 py-2 bg-gray-800 text-white rounded-md hover:bg-gray-700 transition duration-300 text-sm font-medium border border-gray-600">Отмена</a>
                <button type="submit" class="px-4 py-2 bg-gray-800 text-white rounded-md hover:bg-gray-700 transition duration-300 text-sm font-medium border border-gray-600">Создать</button>
            </div>
