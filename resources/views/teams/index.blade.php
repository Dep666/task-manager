    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-8">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a 
                                    ...
                                    class="text-blue-600 hover:text-blue-900 transition duration-200 ease-in-out"
                                >
                                    Редактировать
                                </a>
                                ...
                                <a 
                                    ...
                                    class="ml-4 text-green-600 hover:text-green-900 transition duration-200 ease-in-out"
                                >
                                ...
                                <a 
                                    ...
                                    class="ml-4 text-yellow-600 hover:text-yellow-900 transition duration-200 ease-in-out"
                                >
                                    Список участников
                                </a>
                            </td>
        ...
        <div class="mt-6">
            <a 
                ...
                class="bg-green-600 text-white px-6 py-2 rounded-lg transition duration-300 ease-in-out hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
            >
                Создать команду
            </a>
        </div>
