    ...
    <div class="bg-gray-100 dark:bg-gray-900">
        ...
        <div class="container mx-auto py-12 px-6">
            <div class="text-center">
                ...
                <p class="mt-4 text-lg text-gray-600 dark:text-gray-400">Наш сервис поможет вам эффективно управлять личным временем и работать в команде.</p>
                <p class="mt-4 text-lg text-gray-600 dark:text-gray-400">Создавайте задачи, отслеживайте дедлайны и получайте уведомления прямо в Telegram!</p>
            </div>
            ...
            <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <h2 class="text-2xl font-semibold text-gray-800 dark:text-white">Что мы предлагаем?</h2>
                ...
                <div class="flex flex-col items-center">
                    <img src="{{ asset('img/5252473.jpg') }}" alt="Task Management" class="rounded-lg shadow-lg mb-4 w-3/4 sm:w-1/2 lg:w-40%">
                    <h2 class="text-2xl font-semibold text-gray-800 dark:text-white">Как это работает?</h2>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">
